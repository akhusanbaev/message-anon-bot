...
bot.on("message", async msg => {
  try {
    ...
    if (user.vip && user.trialSearches && !user.vipUntilDate && !user.vipUnlimited && user.trialSearches === 0 && user.state.on !== "chat" && user.state.on !== "ended-chat") await Users.findOneAndUpdate({"user.id": user.user.id}, {vip: false});
